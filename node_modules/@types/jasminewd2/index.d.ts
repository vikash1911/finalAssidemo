import { DoneFn,Expected,MatchersUtil,CustomEqualityTester } from "karma-jasmine";
...
declare function it(expectation: string, assertion?: (done: DoneFn) => Promise<any>, timeout?: number): void;
declare function fit(expectation: string, assertion?: (done: DoneFn) => Promise<any>, timeout?: number): void;
declare function xit(expectation: string, assertion?: (done: DoneFn) => Promise<any>, timeout?: number): void;
declare function beforeEach(action: (done: DoneFn) => Promise<any>, timeout?: number): void;
declare function afterEach(action: (done: DoneFn) => Promise<any>, timeout?: number): void;
declare function beforeAll(action: (done: DoneFn) => Promise<any>, timeout?: number): void;
declare function afterAll(action: (done: DoneFn) => Promise<any>, timeout?: number): void;
